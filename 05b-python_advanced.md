...
>> Frequency table for the following degrees: 
[('PhD', 31), ('ScD', 6), ('MD', 1), ('JD', 1), ('MS', 2), ('MSPH', 0), ('MPH', 2), ('MBA', 0), ('MA', 1), ('BSEd', 1)]



####Q2. Find how many different titles there are, and their frequencies:  Ex:  Assistant Professor, Professor

>> Frequency table for job titles: 
...
>> Here's a list of email addresses: 
...
>> This a count of unique email domains, followed by a list: 
[4, array(['@cceb.med.upenn.edu', '@email.chop.edu', '@mail.med.upenn.edu',
       '@upenn.edu']]
